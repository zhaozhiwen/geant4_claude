...
generic. The **example main** shipped by the **geant4-example** skill
additionally auto-attaches a sensitive detector to every logical volume that carries
...
the file through a quick simulation (the **geant4-run** skill with
`--events 1`).
